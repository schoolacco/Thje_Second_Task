...
## Peer review (Maksim)
* +'s: The game is fun to explore and is very readable for potential new users. I can tell the requirements and specifications are outlined quite well in the code
* -'s: The UI could be more appealing.
* I's: It is very fun to roll and the idea of a god roll is unique and interesting

The review meets the expected expectations... except for it being fun... that is the exact opposite of the goal... Ironically the fact the GUI is not visually appealling was entirely intentional, with the very concept of the game to be rather bland, as every step of the way is not meant to be fun, it is meant to be suffering, yet the user persists in the name of "completion". It was fundementally made to waste time, and the review reflects that, the goal was for to be bland, and it shows it's success in that.
